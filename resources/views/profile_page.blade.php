            ...
            <div class="row">
                <div class="col-lg-4 col-xl-4">
                    <div class="card text-center">
                        <div class="card-body">
                            <img src="{{ asset('templates/assets/images/users/empty-profile.png') }}" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="nama" class="form-control" id="nama" placeholder="Masukkan nama." value="{{ $profile->name }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="email" class="form-label">Email</label>
                                                                <input type="email" name="email" class="form-control" id="email" placeholder="Masukkan email." value="{{ $profile->email }}">
                                                            </div>
                                                        </div>
                                                        <!-- end col -->
                                                    </div> <!-- end row -->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="telepon" class="form-control" id="telepon" placeholder="Masukkan nomor telepon." value="{{ $profile->user_data->telepon }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="nohandphone" class="form-label">Handphone</label>
                                                                <input type="text" class="form-control" id="nohandphone" name="handphone" placeholder="Masukkan nomor handphone." value="{{ $profile->user_data->no_hp }}">
                                                            </div>
                                                        </div> <!-- end col -->
                                                    </div> <!-- end row -->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea class="form-control" id="alamat" name="userbio" rows="4" placeholder="Masukkan alamat. Contoh : Nama jalan, dan yang lainnya.">{{ $profile->user_data->alamat }}</textarea>
                                                            </div>
                                                        </div> <!-- end col -->
                                                    </div> <!-- end row -->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="kota" class="form-control" id="kota" placeholder="Masukkan nomor telepon." value="{{ $profile->user_data->telepon }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                <label for="provinsi" class="form-label">Provinsi</label>
                                                                <input type="text" class="form-control" id="provinsi" name="provinsi" placeholder="Masukkan nomor handphone." value="{{ $profile->user_data->no_hp }}">
                                                            </div>
                                                        </div> <!-- end col -->
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                <label for="kodepos" class="form-label">Kode Pos</label>
                                                                <input type="text" class="form-control" id="kodepos" name="kodepos" placeholder="Masukkan nomor handphone." value="{{ $profile->user_data->no_hp }}">
                                                            </div>
                                                        </div> <!-- end col -->
                                                    </div> <!-- end row -->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea class="form-control" id="userbio" name="userbio" rows="4" placeholder="Tuliskan bio profil anda">{{ $profile->user_data->bio }}</textarea>
                                                            </div>
                                                        </div> <!-- end col -->
                                                    </div> <!-- end row -->
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="fotoprofil" class="form-label">Foto Profil</label>
                                                                 <input type="file" name="fotoprofil" data-plugins="dropify" data-show-errors="true"  data-allowed-file-extensions='["jpg", "png", "jpeg"]' data-height="300" class="dropifyForm"/>
                                                            </div>
                                                        </div>
                                                    </div> <!-- end row -->
