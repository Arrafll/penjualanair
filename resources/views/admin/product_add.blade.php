        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="product-name" class="form-control input-form-product" data-error-label="Nama produk" name="productName" placeholder="Masukkan nama product" form="form-product">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="product-name" class="form-control input-form-product" name="brandName" data-error-label="Nama brand" placeholder="Masukkan nama brand" form="form-product">
                    <div id="" class="invalid-feedback d-none">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control input-form-product" id="product-price" name="price" data-error-label="Harga produk" placeholder="Input harga produk" form="form-product">
                    <div id="" class="invalid-feedback d-none">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control input-form-product" id="product-summary" rows="3" name="productDesc" data-error-label="Deskripsi produk"  placeholder="Masukkan deskripsi produk" form="form-product"></textarea>
                    <div id="" class="invalid-feedback d-none">
                    </div>
                </div>
