            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="product-name" class="form-label">Nama Product <span
                                    class="text-danger">*</span></label>
                            <input type="text" id="product-name" class="form-control input-form-product"
                                data-error-label="Nama produk" name="productName" placeholder="Masukkan nama product"
                                form="form-product" value="{{ $product->name }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control input-form-product" id="product-summary" rows="3" name="productDesc"
                                data-error-label="Deskripsi produk" placeholder="Masukkan deskripsi produk" form="form-product">{{ $product->description }}</textarea>
                            <div id="" class="invalid-feedback d-none">
                            </div>
                        </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin_product_update') }}" method="post" id="form-product"
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <button type="button"
                                                class="btn btn-danger waves-efefct waves-light @if ($attachments->count() == 1) d-none @endif"
                                                    ...
                                                    <div class="col-lg-12 cardUploadFile">
                                                        <div class="mt-3">
                                                            <input type="file" name="files[]" data-plugins="dropify"
                                                                onchange="loadFileName(this) data-show-errors="true"
                                                    ...
                                                    <div class="col-lg-12 cardUploadFile">
                                                        <div class="mt-3">
                                                            <input type="file" name="files[]" data-plugins="dropify"
                                                                ...
                                                                data-default-file="{{ '/uploads' . '/product' . '/' . $att->name }}"
                                                                onchange="loadFileName(this)"
                                                                data-allowed-file-extensions='["jpg", "png", "jpeg"]'
                                                                data-height="300" class="dropifyForm" />
                                                            <input type="hidden" name="existFiles[]"
                                                                value="{{ $att->name }}">
                                                        </div>
                                                    </div>
                                                @endforeach
