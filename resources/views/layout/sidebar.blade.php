<div class="app-menu">  
    ...
    <div class="logo-box">
        ...
        <a href="index.html" class="logo-light">
            <img src="{{ asset('templates/assets/images/logo-text-airmoo.png') }}" alt="logo" class="logo-lg" width="120">
            <img src="{{ asset('templates/assets/images/logo-icon-airmoo.png') }}" alt="small logo" class="logo-sm">
        </a>

        <!-- Brand Logo Dark -->
        <a href="index.html" class="logo-dark">
            <img src="{{ asset('templates/assets/images/logo-text-airmoo.png') }}" alt="dark logo" class="logo-lg" width="120">
            <img src="{{ asset('templates/assets/images/logo-icon-airmoo.png') }}" alt="small logo" class="logo-sm">
        </a>
    </div>
    ...
    <div class="scrollbar">
        ...
        <ul class="menu">
            ...
            <li class="menu-item">
                <a href="/admin_dashboard" class="menu-link {{ (\Request::route()->getName() == 'admin_dashboard') ? 'active' : '' }}">
